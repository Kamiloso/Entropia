...
internal class WorldgenRoot : IWorldgen
{
    ...
    public SectorSpy SectorSpy { get; } = new SectorSpy(EXPONENT, RANGE);
        ...
        WorldFeature[] features = TestCondition(sector.Index)
            ? new[] {
                new Asteroid(
                    ...
                    type: RandomNumberGenerator.GetInt32(2) == 0 ? AsteroidType.Stone : AsteroidType.Amethyst,
                    size: RandomNumberGenerator.GetInt32(30) + 4
                )
            } : new WorldFeature[] { };
